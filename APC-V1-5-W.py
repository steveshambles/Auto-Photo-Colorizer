...
Steve Shambles. Updated June 16th 2020
...
root = Tk()
root.title('Auto Photo Colourizer V1-5-W')
...
def about_menu():
    ...
    messagebox.showinfo('Program Information',
                        'Auto Photo Colourizer V1.5-W\n'
                        'Freeware by Steve Shambles. June 2020\n\n'
...
def help_text():
    ...
    messagebox.showinfo('How To Use Auto Photo Colourizer',
                        ...
                        'drop down menu and choose a folder to process. '
                        '\n\nNon images in the folder may cause APC to crash.\n\n'
                        'A new photo will be created using the old filename '
                        'but with the word "colourized" tagged on the end.\n'
                        'Your original photo will not be changed or deleted.\n\n'
                        )
...
def color_folder_of_imgs():
    ...
    for file in files:
        ...
        fname = (os.path.basename(users_image))  # bogart.jpg
...
file_menu.add_command(label='Donate Me via PayPal', command=donate_me)
file_menu.add_separator()
