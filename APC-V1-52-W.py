...
------------------------------------------------------
V1-52-Credited authors of the AI algo in the about pop up.
...
root = Tk()
root.title('Auto Photo Colourizer V1.52W')
...
def about_menu():
    ...
    messagebox.showinfo('Program Information',
                        ...
                        'This program is 100% free and is the full version.\n'
